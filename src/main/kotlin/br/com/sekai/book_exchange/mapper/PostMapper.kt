...
import br.com.sekai.book_exchange.model.PostId
...
fun PostsVO.toEntity() = Posts( this.postCount, this.date, postId = PostId(this.userID.toEntity(), this.bookID.toEntity()), this.bookInterests)
fun Posts.toVO() = PostsVO( this.postCount, this.date, this.postId.userID.toVOnoPassword(), this.postId.bookID.toVO(), this.bookInterests)
